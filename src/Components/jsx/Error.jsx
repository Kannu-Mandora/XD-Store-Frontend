...
const Error = () => {
  return (
    <>
    <div className='flex flex-col justify-center items-center h-96 overflow-hidden cursor-default' >
       ...
       <Link to="/">
        <span className='bg-primary-color text-white px-3 py-2 rounded hover:bg-red-500'>Home</span>
       </Link>
    </div>
    </>
  )
